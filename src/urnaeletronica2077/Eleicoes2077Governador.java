 ...
 */
public class Eleicoes2077Governador extends javax.swing.JFrame {

    /**
     * Creates new form Eleicoes2077
     */
    public Eleicoes2077Governador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addComponent(foto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
        );
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(nomedep, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE)
   ...
   public void voto(){
    ...
    Candidatos candidato1 = new Candidatos ("ACM NETO","BRX");
    Candidatos candidato2 = new Candidatos ("JERONIMO","CRX");
    Candidatos candidato3 = new Candidatos ("JOÃO ROMA","DRX");
    Candidatos candidato4 = new Candidatos ("KLEBER ROSA","FRX");
    Candidatos candidato5 = new Candidatos ("RUI COSTA","GRX");
    ...
    if("0".equals(cx1) && "6".equals(cx2)){
        nomedep.setText("VOTO BRANCO");
        partdep.setText("VOTO BRANCO");
        Candidatos.add(branco);
    }else if("9".equals(cx1) && "6".equals(cx2) ){
        nomedep.setText("VOTO NULO");
        partdep.setText("VOTO NULO");
        Candidatos.add(nulo);
    }else if("1".equals(cx1) && "6".equals(cx2) ){
        nomedep.setText("ACM NETO");
        partdep.setText("BRX");
        foto1();
        Candidatos.add(candidato1);//estou adicionando esse candidato na lista
    }else if("2".equals(cx1) && "6".equals(cx2)){
        nomedep.setText("JERONIMO");
        partdep.setText("CRX");
        foto2();
        Candidatos.add(candidato2);
    }else if("3".equals(cx1) && "6".equals(cx2)){
        nomedep.setText("JOÃO ROMA");
        partdep.setText("DRX");
        foto3();
        Candidatos.add(candidato3);
    }else if("4".equals(cx1) && "6".equals(cx2) ){
        nomedep.setText("KLEBER ROSA");
        partdep.setText("FRX");
        foto4();
        Candidatos.add(candidato4);
    }else if("5".equals(cx1) && "6".equals(cx2)){
        nomedep.setText("RUI COSTA");
        partdep.setText("CRX");
        foto5();
   ...
   public void resultadoDaEleicao(){
    ...
    public void foto1(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("yACM Neto.jpg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto2(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("yJeronimo.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto3(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("yJoão Roma.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto4(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("yKleber Rosa.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto5(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("yRui Costa.jpg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    ...
    private void botconfirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botconfirmaActionPerformed
       ...
       Eleicoes2077Presidente obj1voto = new Eleicoes2077Presidente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eleicoes2077Governador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Eleicoes2077Governador().setVisible(true);
