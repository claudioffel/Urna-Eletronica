 ...
 */
public class Eleicoes2077Presidente extends javax.swing.JFrame {

    /**
     * Creates new form Eleicoes2077
     */
    public Eleicoes2077Presidente() {
        initComponents();
    }
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(nomedep, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
   ...
   public void voto(){
    ...
    Candidatos candidato1 = new Candidatos ("LULA","BRX");
    Candidatos candidato2 = new Candidatos ("JAIR","CRX");
    Candidatos candidato3 = new Candidatos ("CIRO","DRX");
    Candidatos candidato4 = new Candidatos ("SIMONE","FRX");
    Candidatos candidato5 = new Candidatos ("SORAIA","GRX");
   ...
   if("0".equals(cx1) && "0".equals(cx2)){
        nomedep.setText("VOTO BRANCO");
        partdep.setText("VOTO BRANCO");
        Candidatos.add(branco); 
   }if("9".equals(cx1) && "9".equals(cx2)){
        nomedep.setText("VOTO NULO");
        partdep.setText("VOTO NULO");
        Candidatos.add(nulo);
    }else if("1".equals(cx1) && "1".equals(cx2) ){
        nomedep.setText("LULA");
        partdep.setText("BRX");
        foto1();
        Candidatos.add(candidato1);//estou adicionando esse candidato na lista
    }else if("2".equals(cx1) && "2".equals(cx2)){
        nomedep.setText("JAIR");
        partdep.setText("CRX");
        foto2();
        Candidatos.add(candidato2);
    }else if("3".equals(cx1) && "3".equals(cx2)){
        nomedep.setText("CIRO");
        partdep.setText("DRX");
        foto3();
        Candidatos.add(candidato3);
    }else if("4".equals(cx1) && "4".equals(cx2) ){
        nomedep.setText("SIMONE");
        partdep.setText("FRX");
        foto4();
        Candidatos.add(candidato4);
    }else if("5".equals(cx1) && "5".equals(cx2)){
        nomedep.setText("SORAIA");
        partdep.setText("CRX");
        foto5();
   ...
   public void resultadoDaEleicao(){
    ...
    public void foto1(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("xLula.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto2(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("xJair.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto3(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("xCiro.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto4(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("xSimone.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    
     public void foto5(){
        ImageIcon ftcandidato = new ImageIcon(getClass().getResource("xSoraia.jpeg"));
        ftcandidato.setImage(ftcandidato.getImage().getScaledInstance(foto.getWidth(),foto.getHeight(),1));
        foto.setIcon(ftcandidato);       
    }
    ...
    private void botconfirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botconfirmaActionPerformed
       ...
       Eleicoes2077Fim obj1voto = new Eleicoes2077Fim();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eleicoes2077Presidente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Eleicoes2077Presidente().setVisible(true);
